...
const BatchJobs = () => {
  ...
  const filteredJobs = jobsData.filter(job => job.batch.toString() === batch);
    ...
    <>
      ...
      <div className="container mx-auto p-4">
        ...
        {currentJobs.length > 0 ? (
          ...
          <p className="text-center text-red-500">No jobs available for Batch {batch}.</p>
        )}
        {/* Pagination Controls */}
        {totalPages > 1 && (
